...
- **Historia de las anacondas:**  
  Las anacondas, por querer proteger a su rey, atacan sin mirar a quién. Únicamente siguen sus órdenes, siendo demasiado cortas de mente como para darse cuenta de que están siendo manipuladas.  
  El único punto débil de las anacondas es la cabeza.

- **Estilo de arte:**  
  Las anacondas tendrán un estilo de arte animado y llevarán un poncho.
...
### Enemigo 1: Mulatos Azules

- **Historia de los Mulatos Azules:**  
  Los Mulatos Azules le pedían cobro de piso al pingüino (el protagonista), quien no contaba con dicha moneda. Por ello, los Mulatos Azules, una banda de extorsionadores, atacan al pingüino sin piedad.  
  Durante el combate, uno de ellos puede **llamar a los demás miembros de la banda** para unirse al ataque.

- **Estilo de arte:**  
  Los Mulatos Azules tendrán un estilo de arte animado.  
  Llevarán **paliacate**, **lentes oscuros** y un **tatuaje característico** el cual identifica al Mulato que puede llamar a los demás.  
  Los otros miembros invocados llevarán únicamente **lentes oscuros**.

- **Ataques y comportamiento:**  
  Los ataques de los Mulatos Azules serán de dos tipos.  
  Cuentan con **30 puntos de vida**, mientras que las **invocaciones** tienen **15 puntos de vida** cada una.  
...
- **Historia de los Castores:**  
  Durante el accidente que tuvo nuestro protagonista para llegar a **Alaska**, destruyó una **presa construida por los castores**.  
  A causa de esto, los castores están **sumamente enfadados** y harán todo lo posible por **derrotar al protagonista** en venganza.

- **Estilo de arte:**  
  Los castores tendrán un **estilo de arte animado**, portando un **casco hecho de madera** y **herramientas en su espalda**, reflejando su naturaleza trabajadora y su conexión con la construcción.

- **Ataques y comportamiento:**  
  Los castores son **enemigos estratégicos**, capaces de adaptarse a la clase o equipamiento del jugador, fabricando **equipamiento de madera** que contrarresta las habilidades del protagonista.  
  Cuentan con **30 puntos de vida**, causan **3 puntos de daño** por ataque y tienen una **velocidad media**.

  - **Wooden Maiden (Protección):**  
    El castor se introduce en un **tótem canadiense** que utiliza como defensa.  
    Mientras permanece dentro, **se cura 1 punto de vida cada 0.5 segundos**.  
...
### Enemigo 1 Osos Polares Navideños de Coca Cola

- **Historia de los Osos Polares Navideños de Coca Cola (Opciones):**  
  **Historia 1:**  
  Estos osos fueron bendecidos por Santa Claus con el don de la **Coca Cola**, lo que les permite hacerse más fuertes tanto al pelear como simplemente al existir.  
  El protagonista deberá enfrentarse a ellos para **robarles su Coca Cola** y así poder reunir la fuerza necesaria para combatir a **Santa Claus**.  

  **Historia 2:**  
  Los osos polares son grandes fanáticos de la Coca Cola gracias a que **Santa Claus es su principal exportador**.  
  No toleran que nadie consuma **Pepsi** o **Red Cola**.  
  Cuando el protagonista llega al **estrecho de Bering**, los osos lo ven recogiendo una lata de Pepsi, y por ese simple gesto comienzan a **odiarlo profundamente**.

- **Estilo de arte:**  
  Los Osos Polares Navideños de Coca Cola tendrán un **estilo animado**, vistiendo su **bufanda roja de Coca Cola** y sosteniendo una **botella de Coca Cola** en una de sus garras.

- **Ataques y comportamiento:**  
  Los Osos Polares son **enemigos extremadamente fuertes y resistentes**.  
  Cuentan con **60 puntos de vida** y pueden infligir un daño de **7 puntos por golpe** en su forma normal.  
  Cuando están **potenciados por la Coca Cola**, su daño aumenta a **9 o 10 puntos** por ataque.  

  - **Melee:**  
    Un ataque cuerpo a cuerpo **medianamente lento**, pero **muy poderoso**, capaz de causar gran daño si impacta.  
